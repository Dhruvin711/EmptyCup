"""
Django settings for emptycup project.
...
SECRET_KEY = 'django-insecure-l29p6b-3t0@t3cjw6hnvnsx7)rqs5l3sb*)*!^zh2oxptw1@%b'
...
WSGI_APPLICATION = 'emptycup.wsgi.application'
